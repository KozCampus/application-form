<script lang="ts" module>
	...
	export const sidebarMenuButtonVariants = tv({
		...
		variants: {
			variant: {
				default: 'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground select-none',
				outline:
...
<script lang="ts">
	...
	import { mergeProps, type TooltipTriggerProps } from 'bits-ui';
...
{#snippet Button({ props }: { props?: TooltipTriggerProps })}
